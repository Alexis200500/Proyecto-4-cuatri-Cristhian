  ...
  <body>
   ...
   <aside id="colorlib-hero">
      <div class="flexslider">
        <ul class="slides">
          <li style="background-image: url(images/tour-1.jpg);">
        ...
        <div class="row block-9 mb-4">
          <div class="col-md-6 pr-md-5 flex-column">
            <div class="row d-block flex-row">
              <h2 class="h4 mb-4">Cambio de Contraseña</h2>
            ...
            <form action="/password/{{$id}}" method="POST">
              ...
              <div class="form-group">
              <label>Repite nuevamente la nueva contraseña</label>
                <input type="password" class="form-control" placeholder="Password" value="{{old('password')}}" name="password_r">
              </div>
