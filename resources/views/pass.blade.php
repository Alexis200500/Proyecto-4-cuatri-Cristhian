    ...
    <section class="ftco-section contact-section">
      <div class="container">
        <div class="row block-9 mb-4">
          <div class="col-md-12 pr-md-5 flex-column">
            <div class="row d-block flex-row">
              <br><br><br>
              <h2 class="h4 mb-12">Cambio de Contraseña</h2>

            <form action="/enviocorreo" method="POST">
                 {{ csrf_field() }}
              <div class="form-group">
                <label>Introduce el correo electronico</label>
                <br>
                <input type="email" class="form-control" placeholder="Correo Electronico" value="{{old('correo')}}" name="correo">
              </div>
             
              <div class="form-group">
                <input type="submit" value="Enviar Correo" class="btn btn-primary py-9 px-5">
                <br><br><br>
              </div>
            </form>
            </div>
        ...
        <div class="row row-pb-md">
          ...
          <div class="col-md-3 col-md-push-1">
            ...
            <ul class="colorlib-footer-links">
              ...
              <li><a href="mailto:al221811702.com">al221811702@gmail.com</a></li>
