...
<div class="form-group">
  <input type="text" onblur="nom()" class="form-control" id="Nombre" placeholder="Nombre" value="{{$usuario->nombre}}" name="nombre">
  {!! $errors->first('nombre','<div class="alert alert-warning" role="alert"><span class="help-block">:message </span></div>') !!} 
</div>
<div id="namerror"></div>

<div class="form-group">
  <input type="text" onblur="cor()" class="form-control" id="Correo" placeholder="Correo" value="{{$usuario->correo}}" name="correo">
  {!! $errors->first('correo','<div class="alert alert-warning" role="alert"><span class="help-block">:message </span></div>') !!} 
</div>
<div id="corerror"></div>

<div class="form-group">
  <input type="password" onblur="pass()" class="form-control" id="Password" placeholder="Password" value="{{$usuario->password}}" name="password">
