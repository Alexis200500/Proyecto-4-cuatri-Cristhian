...
<html lang="en" dir="ltr">
  ...
  <body>
    <form class="content" action="{{route('altausuario')}}" method="POST">
      ...
      <input type="text" name="Matricula" onblur="fieldSize()" id="matricula" pattern="[10 []]+" placeholder="Matricula">
      <p id="error"></p>
      ...
      <p id="error3"></p>
      <input type="date" name="FN" onblur="fieldSize4()" id="fn" pattern="[0-9\/]+" placeholder="Fecha de Nacimiento">
      <p id="error4"></p>
      <select name="Genero" onblur="fieldSize5()" id="genero" pattern="[F]|[M]+">
      ...
      <p id="error7"></p>
      <input type="email" name="Email" onblur="fieldSize8()" id="email" pattern="[a-zA-Z0-9\/.*@]+" placeholder="Email">
      <p id="error8"></p>
