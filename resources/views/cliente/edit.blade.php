...
<div class="col-md-12 padding-bottom">
    <div class="col-md-12">
		...
		<input type="text" value="{{$cliente->nombre}}" name="nombre" class="form-control" onblur="fieldSize1()" id="nombre" pattern="[a-zA-Z]+" placeholder="Escribe tu nombre(s)">
	</div>
	<div class="col-md-12">
		<label for="lname">Apellido Paterno</label>
		<input type="text" name="app" value="{{$cliente->app}}" onblur="fieldSize2()" id="app" pattern="[a-zA-Z]+" class="form-control" placeholder="Escribe tu Apellido"><p id="error2"></p>
	</div>
	<div class="col-md-12">
		<label for="lname">Apellido Materno</label>
		<input type="text" name="apm" value="{{$cliente->apm}}" onblur="fieldSize2()" id="apm" pattern="[a-zA-Z]+" class="form-control" placeholder="Escribe tu Apellido"><p id="error3"></p>
	</div>
</div>
...
<div class="row form-group">
	<div class="col-md-6" class="form-group">
      ...
      <div class="form-field">
        <input class="form-control" value="{{$cliente->fn}}" type="date" name="fn" onblur="fieldSize4()" id="fn" pattern="[0-9\/]+" placeholder="Fecha de Nacimiento"><p id="error4"></p>
      </div>
    </div>
    <div class="col-md-6" class="form-group">
...
<div class="row form-group">
	<div class="col-md-12">
		...
		<input  type="text" value="{{$cliente->telefono}}" name="telefono" onblur="fieldSize6()" id="telefono" pattern="[10 []]+" class="form-control" placeholder="Escriba su número de teléfono"><p id="error6"></p>
	</div>
</div>
