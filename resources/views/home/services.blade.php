...
<html>
	...
	<title>Viajes con Experiencia | Servicios</title>
					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="active"><a href="{{ route('services') }}">Servicios</a></li>
				...
				<div class="row">
					...
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							...
							<p>Disfruta de un hermoso viaje a bordo de un Crucero, Desciende por medio de rappel asistido hasta llegar a las aguas de un cenote de caverna, Siente la adrenalina al deslizarte en las tirolesas de dos diferentes cenotes, Rema a bordo de un kayak entre los muros de piedra tapizados por los jardines colgantes de un cenote semiabierto, Admira la vida acuática</p>
						</div>
					</div>
					<div class="col-md-3 animate-box text-center">
						<div class="services">
					...
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							...
							<h3>Guia Privada</h3>
							<p>Tendrás una guía personalizada con cada uno de los lugares que puedes visitar, así como recomendaciones y comentarios y estrellas del lugar</p>
						</div>
					</div>
				</div>
			</div>
