...
@section('contenido')	
<form action="{{ url('/crucero/' .$crucero->id) }}" method="POST" enctype="multipart/form-data">
	{{ csrf_field() }}
	{{ method_field('PUT') }}
    ...
    <div class="col-md-12">
	    <div class="form-group">
	        ...
	        <div class="form-field">
	            <input type="text" value="{{$crucero->donde}}" name="crucero" onblur="fieldSizeCrucero()" id="crucero" pattern="[a-zA-Z]+" class="form-control" placeholder="Buscar localización"><p id="errorCrucero"></p>
	        </div>
	    </div>
	</div>
	<div class="col-md-12">
	  <div class="form-group">
	    ...
	    <div class="form-field">
	      ...
	      <input type="date" name="fecha" value="{{$crucero->fechadeinicio}}" onblur="fieldSizeFecha()" id="fecha" pattern="[0-9\/]+" class="form-control" placeholder="Verificar Fecha"><p id="errorFecha"></p>
	    </div>
	  </div>
	</div>
	<div class="col-md-12">
