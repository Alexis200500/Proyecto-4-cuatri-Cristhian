  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{ route('indexadmin') }}" class="d-block">Bienvenido</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="{{url('alquiler')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('crucero')}}" class="nav-link">
              <i class="fa fa-ship nav-icon"></i>
              <p>Cruceros</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{url('hotel')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('vuelo')}}" class="nav-link">
